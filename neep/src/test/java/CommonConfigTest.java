...
public class CommonConfigTest extends TestPlatform {
    ...
    public void playerInfo() throws Exception {
        ...
        PlayerInfo obj = deserialize(PlayerInfo.class, conf.getRoot());
    ...
    public void userGroup() throws Exception {
        ...
        RoleTable obj = deserialize(RoleTable.class, conf.getRoot());
    ...
    public void market() throws Exception {
        ...
        m = deserialize(Market.class, ((NeepConfigSection) configSection).getBackend());
    ...
    public void menu() throws Exception {
        ...
        m = deserialize(Menu.class, ((NeepConfigSection) configSection).getBackend());
    ...
    public void codeMap() throws Exception {
        ...
        map = deserialize(CodeMap.class, ((NeepConfigSection) configSection).getBackend());
