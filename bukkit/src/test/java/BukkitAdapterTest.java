...
public class BukkitAdapterTest extends TestPlatform {
    ...
    public void location1() throws Exception {
        ...
        wm.centralLocation = new Location(null, 0.01, 50, 0.01);
        wm.allHomes.add(new Location(null, 34.05, 50, -128.72));
        wm.allHomes.add(new Location(null, 65.12, 57.3, 98.203));
        wm.allHomes.add(new Location(null, -111.77, 63, -27.1));
        wm.buildings.put("Market", new Location(null, 90.4, 60, 23.32));
        wm.buildings.put("Park", new Location(null, -32, 55, 40));
        wm.centerRegions = new WorldMap.Region();
        wm.centerRegions.highlightedPos.add(new Location(null, 1, 1, 1));
    ...
    public void location2() throws Exception {
        WorldMap wm = new WorldMap();
        wm.allHomes.add(new Location(null, -111.77, 40.32, -27.1));
        wm.allHomes.add(new Location(null, 108, 37, -10.2));
        wm.allHomes.add(new Location(null, 72, 32.5, 91));
