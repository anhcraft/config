...
public class ReflectSchemaScannerImpl implements ReflectSchemaScanner {
  ...
  public @NotNull ClassSchema scanSchema(@NotNull Class<?> type) {
    ...
    ReflectSchemaScannerImpl.PropertyScanResult propertyListResult =
        scanPropertyList(
    ...
    LazyEffectivePropertyResult effectivePropertyResult =
        new LazyEffectivePropertyResult(this, type, encapsulationEnforced);

    //noinspection unchecked
    List<ClassProperty> effectivePropertyList =
        (List<ClassProperty>)
            Proxy.newProxyInstance(
                dev.anhcraft.config.blueprint.ReflectSchemaScanner.class.getClassLoader(),
  ...
  @NotNull ReflectSchemaScannerImpl.PropertyScanResult scanPropertyList(
    ...
    */
    ...
    ReflectSchemaScannerImpl.PropertyScanResult result =
        new ReflectSchemaScannerImpl.PropertyScanResult();
