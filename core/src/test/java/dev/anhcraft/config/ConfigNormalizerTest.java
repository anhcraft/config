...
public class ConfigNormalizerTest {
    ...
    public void testIgnoreTypeAnnotator() throws Exception {
        ConfigNormalizer normalizer = ConfigFactory.create()
                .adaptType(DummyYummy.class, new TypeAnnotator<>(){
                    @Override
                    public @Nullable DummyYummy complexify(@NotNull Context ctx, @NotNull Object value, @NotNull Type targetType) throws Exception {
                        return null;
                    }
                })
                .build().getNormalizer();
    ...
    public void testCheckTypeReturnedFromAdapter() {
        ConfigNormalizer normalizer = ConfigFactory.create()
                .adaptType(DummyYummy.class, new TypeAdapter<>() {
                    @Override
    ...
    public class TestNormalizeIntoDictionary {
        ...
        public void testShallowCopyDictionary() throws Exception {
            ...
            factory.getNormalizer().normalizeToDictionary(factory.createContext(), Dictionary.class, foo, bar);
            pet[0] = "cat";
    ...
    public class TestNormalizeInstanceUsingSchema {
        ...
        public void testIgnoreEmptyArray() throws Exception {
            ConfigFactory factory = ConfigFactory.create().ignoreDefaultValues(true).ignoreEmptyArray(true).build();
            Transaction transaction = new Transaction();
        ...
        public void testIgnoreEmptyDictionary() throws Exception {
            ConfigFactory factory = ConfigFactory.create()
                    ...
                    .ignoreEmptyDictionary(true).build();
            Transaction transaction = new Transaction();
