...
public class ComplexTypesTest {
    ...
    public void testGetComponentType() {
        assertEquals(new TypeToken<List<Integer>>(){}.capture(), ComplexTypes.getComponentType(new TypeToken<List<Integer>[]>(){}.capture()));
        assertEquals(new TypeToken<List<Integer>>(){}.capture(), ComplexTypes.getComponentType(new TypeToken<List<Integer>[]>(){}));
        assertEquals(new TypeToken<List<Integer>[]>(){}.capture(), ComplexTypes.getComponentType(new TypeToken<List<Integer>[][]>(){}));
    ...
    public void testDescribe() {
        ...
        assertEquals("int[]", ComplexTypes.describe(int[].class));
        assertEquals("int[][]", ComplexTypes.describe(int[][].class));
        assertEquals("java.util.List<java.lang.Integer>", ComplexTypes.describe(new TypeToken<List<Integer>>(){}.capture()));
        assertEquals("java.util.List<int[]>", ComplexTypes.describe(new TypeToken<List<int[]>>(){}.capture()));
        assertEquals("java.util.List<java.util.Map<java.lang.String[],java.util.Set<int[][]>[]>>", ComplexTypes.describe(new TypeToken<List<Map<String[], Set<int[][]>[]>>>(){}.capture()));
        assertEquals("dev.anhcraft.config.SettingFlag$Normalizer", ComplexTypes.describe(SettingFlag.Normalizer.class));
    ...
    public void testGetActualTypeArgument() {
        assertEquals(Integer.class, ComplexTypes.getActualTypeArgument(new TypeToken<List<Integer>>(){}.capture(), 0));
        assertNull(ComplexTypes.getActualTypeArgument(new TypeToken<List<Integer>>(){}.capture(), 1));
        assertInstanceOf(WildcardType.class, ComplexTypes.getActualTypeArgument(new TypeToken<List<?>>(){}.capture(), 0));
