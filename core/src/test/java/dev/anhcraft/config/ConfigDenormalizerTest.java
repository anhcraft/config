...
public class ConfigDenormalizerTest {
    ...
    public void testDenormalizeArray() throws Exception {
        ConfigDenormalizer denormalizer = ConfigFactory.create().build().getDenormalizer();
        assertArrayEquals(new int[]{1, 2, 3}, (int[]) denormalizer.denormalize(new String[]{"1", "2", "3"}, int[].class));
        assertArrayEquals(new int[]{49, 50, 51}, (int[]) denormalizer.denormalize(new char[]{'1', '2', '3'}, int[].class));
        assertArrayEquals(new int[]{1, 2, 3}, (int[]) denormalizer.denormalize(new double[]{1.0001, 2.21, 3.00042}, int[].class));
    }
    ...
    public void testDenormalizeArray2D() throws Exception {
        ...
        assertArrayEquals(new int[][]{
                ...
                new int[]{4, 5, 6},
                new int[]{7, 8, 9}
        }, (int[][]) denormalizer.denormalize(new String[][]{
                new String[]{"1", "2", "3"},
                new String[]{"4", "5", "6"},
                new String[]{"7", "8", "9"}
        }, int[][].class));
    ...
    public void testIgnoreTypeInferencer() throws Exception {
        ConfigDenormalizer denormalizer = ConfigFactory.create()
                .adaptType(DummyYummy.class, new TypeInferencer<>() {
                    @Override
                    public @Nullable Object simplify(@NotNull Context ctx, @NotNull Class<? extends DummyYummy> sourceType, @NotNull DummyYummy value) throws Exception {
                        return null;
                    }
                })
                .build().getDenormalizer();
        assertInstanceOf(DummyYummy.class, denormalizer.denormalize(new Dictionary(), DummyYummy.class));
    }
    ...
    public void testCheckTypeReturnedFromAdapter() {
        ...
        ConfigDenormalizer denormalizer = ConfigFactory.create()
                .adaptType(DummyYummy.class, (TypeAdapter) new TypeAdapter<Object>(){

                    @Override
                    public @Nullable Object simplify(@NotNull Context ctx, @NotNull Class<?> sourceType, @NotNull Object value) throws Exception {
                        return null;
                    }
                ...
                .build().getDenormalizer();
        assertThrows(IllegalTypeException.class, () -> denormalizer.denormalize(new DummyYummy(), DummyYummy.class));
    }
    ...
    public class TestDenormalizeDictionaryUsingSchema {
        ...
        public void testValidate() {
            ...
            assertThrows(InvalidValueException.class, () -> factory.getDenormalizer().denormalizeToInstance(dict, Transaction.class, new Transaction()));
        }
    }
