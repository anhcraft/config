...
public class IntegerAdapterTest {;
    ...
    public void testComplexifyNumber() throws Exception {
        ...
        assertEquals((int) Float.MIN_VALUE, adapter.complexify(context, Float.MIN_VALUE, Integer.class));
        assertEquals((int) Double.MIN_VALUE, adapter.complexify(context, Double.MIN_VALUE, Integer.class));
        ...
        assertEquals((int) Float.MAX_VALUE, adapter.complexify(context, Float.MAX_VALUE, Integer.class));
        assertEquals((int) Double.MAX_VALUE, adapter.complexify(context, Double.MAX_VALUE, Integer.class));
    }
    ...
    public void testComplexifyString() throws Exception {
        ...
        assertThrowsExactly(InvalidValueException.class, () -> adapter.complexify(context, "", Integer.class));
        assertThrowsExactly(InvalidValueException.class, () -> adapter.complexify(context, "one", Integer.class));
    }
    ...
    public void testComplexifyStringStrictly() throws Exception {
        ...
        assertThrowsExactly(InvalidValueException.class, () -> adapter.complexify(strict, "", Integer.class));
        assertThrowsExactly(InvalidValueException.class, () -> adapter.complexify(strict, "one", Integer.class));
        assertThrowsExactly(InvalidValueException.class, () -> adapter.complexify(strict, "1.001", Integer.class));
        assertThrowsExactly(InvalidValueException.class, () -> adapter.complexify(strict, "-2.1", Integer.class));
    }
