...
public class ShortAdapterTest {;
    ...
    public void testComplexifyNumber() throws Exception {
        ...
        assertEquals((short) Integer.MIN_VALUE, adapter.complexify(context, Integer.MIN_VALUE, Short.class));
        assertEquals((short) Long.MIN_VALUE, adapter.complexify(context, Long.MIN_VALUE, Short.class));
        assertEquals((short) Float.MIN_VALUE, adapter.complexify(context, Float.MIN_VALUE, Short.class));
        assertEquals((short) Double.MIN_VALUE, adapter.complexify(context, Double.MIN_VALUE, Short.class));
        assertEquals((short) Integer.MAX_VALUE, adapter.complexify(context, Integer.MAX_VALUE, Short.class));
        assertEquals((short) Long.MAX_VALUE, adapter.complexify(context, Long.MAX_VALUE, Short.class));
        assertEquals((short) Float.MAX_VALUE, adapter.complexify(context, Float.MAX_VALUE, Short.class));
        assertEquals((short) Double.MAX_VALUE, adapter.complexify(context, Double.MAX_VALUE, Short.class));
    }
    ...
    public void testComplexifyString() throws Exception {
        ...
        assertThrowsExactly(InvalidValueException.class, () -> adapter.complexify(context, "", Short.class));
        assertThrowsExactly(InvalidValueException.class, () -> adapter.complexify(context, "one", Short.class));
    }
    ...
    public void testComplexifyStringStrictly() throws Exception {
        ...
        assertThrowsExactly(InvalidValueException.class, () -> adapter.complexify(strict, "1.001", Short.class));
        assertThrowsExactly(InvalidValueException.class, () -> adapter.complexify(context, "", Short.class));
        assertThrowsExactly(InvalidValueException.class, () -> adapter.complexify(context, "one", Short.class));
    }
