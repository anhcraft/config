...
public class ByteAdapterTest {
  ...
  public void testComplexifyNumber() throws Exception {
    ...
    assertEquals(
        (byte) Integer.MIN_VALUE, adapter.complexify(context, Integer.MIN_VALUE, Byte.class));
    ...
    assertEquals(
        (byte) Double.MIN_VALUE, adapter.complexify(context, Double.MIN_VALUE, Byte.class));
    assertEquals((byte) Short.MAX_VALUE, adapter.complexify(context, Short.MAX_VALUE, Byte.class));
    assertEquals(
        (byte) Integer.MAX_VALUE, adapter.complexify(context, Integer.MAX_VALUE, Byte.class));
    ...
    assertEquals(
        (byte) Double.MAX_VALUE, adapter.complexify(context, Double.MAX_VALUE, Byte.class));
  }
  ...
  public void testComplexifyString() throws Exception {
    ...
    assertThrowsExactly(
        InvalidValueException.class, () -> adapter.complexify(context, "", Byte.class));
    assertThrowsExactly(
        InvalidValueException.class, () -> adapter.complexify(context, "one", Byte.class));
  }
  ...
  public void testComplexifyStringStrictly() throws Exception {
    ...
    assertThrowsExactly(
        InvalidValueException.class, () -> adapter.complexify(strict, "1.001", Byte.class));
    assertThrowsExactly(
        InvalidValueException.class, () -> adapter.complexify(strict, "256", Byte.class));
    assertThrowsExactly(
        InvalidValueException.class, () -> adapter.complexify(strict, "-129", Byte.class));
    assertThrowsExactly(
        InvalidValueException.class, () -> adapter.complexify(context, "", Byte.class));
    assertThrowsExactly(
        InvalidValueException.class, () -> adapter.complexify(context, "one", Byte.class));
