...
public class FloatAdapterTest {
    ...
    public void testComplexifyString() throws Exception {
        ...
        assertEquals(Float.POSITIVE_INFINITY, adapter.complexify(context, "  3.4028235E39", Float.class), 1e-8);
        assertThrowsExactly(InvalidValueException.class, () -> adapter.complexify(context, "", Float.class));
        assertThrowsExactly(InvalidValueException.class, () -> adapter.complexify(context, "--2.3", Float.class));
        assertThrowsExactly(InvalidValueException.class, () -> adapter.complexify(context, "0.000a", Float.class));
        assertThrowsExactly(InvalidValueException.class, () -> adapter.complexify(context, "1..02", Float.class));
    }
    ...
    public void testComplexifyStringStrictly() throws Exception {
        ...
        assertEquals(Float.MAX_VALUE, adapter.complexify(context, "  3.4028235E38", Float.class), 1e-8);
        assertEquals(Float.POSITIVE_INFINITY, adapter.complexify(context, "  3.4028235E39", Float.class), 1e-8);
        assertThrowsExactly(InvalidValueException.class, () -> adapter.complexify(strict, "", Float.class));
        assertThrowsExactly(InvalidValueException.class, () -> adapter.complexify(strict, "--2.3", Float.class));
        assertThrowsExactly(InvalidValueException.class, () -> adapter.complexify(strict, "0.000a", Float.class));
        assertThrowsExactly(InvalidValueException.class, () -> adapter.complexify(strict, "1..02", Float.class));
    }
