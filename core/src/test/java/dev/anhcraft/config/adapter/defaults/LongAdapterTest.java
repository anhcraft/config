...
public class LongAdapterTest {
  ...
  public void testComplexifyNumber() throws Exception {
    ...
    assertEquals(
        (long) Double.MIN_VALUE, adapter.complexify(context, Double.MIN_VALUE, Long.class));
    ...
    assertEquals(
        (long) Double.MAX_VALUE, adapter.complexify(context, Double.MAX_VALUE, Long.class));
  }
  ...
  public void testComplexifyString() throws Exception {
    ...
    assertThrowsExactly(
        InvalidValueException.class, () -> adapter.complexify(context, "", Long.class));
    assertThrowsExactly(
        InvalidValueException.class, () -> adapter.complexify(context, "one", Long.class));
  }
  ...
  public void testComplexifyStringStrictly() throws Exception {
    ...
    assertThrowsExactly(
        InvalidValueException.class, () -> adapter.complexify(strict, "", Long.class));
    assertThrowsExactly(
        InvalidValueException.class, () -> adapter.complexify(strict, "one", Long.class));
    assertThrowsExactly(
        InvalidValueException.class, () -> adapter.complexify(strict, "1.001", Long.class));
    assertThrowsExactly(
        InvalidValueException.class, () -> adapter.complexify(strict, "-2.1", Long.class));
  }
