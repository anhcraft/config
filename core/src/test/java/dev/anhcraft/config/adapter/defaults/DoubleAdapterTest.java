...
public class DoubleAdapterTest {
  ...
  public void testComplexifyString() throws Exception {
    ...
    assertEquals(
        9999999999.12345d, adapter.complexify(context, " 9999999999.12345", Double.class), 1e-8);
    assertThrowsExactly(
        InvalidValueException.class, () -> adapter.complexify(context, "", Double.class));
    assertThrowsExactly(
        InvalidValueException.class, () -> adapter.complexify(context, "--2.3", Double.class));
    assertThrowsExactly(
        InvalidValueException.class, () -> adapter.complexify(context, "0.000a", Double.class));
    assertThrowsExactly(
        InvalidValueException.class, () -> adapter.complexify(context, "1..02", Double.class));
  }
  ...
  public void testComplexifyStringStrictly() throws Exception {
    ...
    assertEquals(
        9999999999.12345d, adapter.complexify(context, " 9999999999.12345", Double.class), 1e-8);
    assertThrowsExactly(
        InvalidValueException.class, () -> adapter.complexify(strict, "", Double.class));
    assertThrowsExactly(
        InvalidValueException.class, () -> adapter.complexify(strict, "--2.3", Double.class));
    assertThrowsExactly(
        InvalidValueException.class, () -> adapter.complexify(strict, "0.000a", Double.class));
    assertThrowsExactly(
        InvalidValueException.class, () -> adapter.complexify(strict, "1..02", Double.class));
  }
