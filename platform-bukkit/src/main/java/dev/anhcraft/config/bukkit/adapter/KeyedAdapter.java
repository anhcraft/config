...
public class KeyedAdapter implements TypeAdapter<Keyed> {
  ...
  @Override
  public @Nullable Object simplify(@NotNull Context ctx, @NotNull Class<? extends Keyed> sourceType, @NotNull Keyed value) throws Exception {
    return ctx.simplify(ctx, NamespacedKey.class, value.getKey());
  }

  @Override
  public @Nullable Keyed complexify(@NotNull Context ctx, @NotNull Object value, @NotNull Type targetType) throws Exception {
