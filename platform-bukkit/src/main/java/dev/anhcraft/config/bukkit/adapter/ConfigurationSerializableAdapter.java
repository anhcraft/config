...
public class ConfigurationSerializableAdapter implements TypeAdapter<ConfigurationSerializable> {
  public static final ConfigurationSerializableAdapter INSTANCE =
      new ConfigurationSerializableAdapter();
  ...
  public @Nullable Object simplify(
      @NotNull Context ctx,
      @NotNull Class<? extends ConfigurationSerializable> sourceType,
      @NotNull ConfigurationSerializable value)
      throws Exception {
    return serialize(ctx, value.serialize());
  }

  @Override
  public @Nullable ConfigurationSerializable complexify(
